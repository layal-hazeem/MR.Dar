...
class MyLocale implements Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    "ar": {
      ...
      "Any notes or if your city does not exist":
          "دوّن ملاحظاتك,أو بحال مدينتك غير موجودة",
      ...
      "Editing will cancel the current request and create a new one. Continue?":
          "سيؤدي التعديل إلى إلغاء الطلب الحالي وإنشاء طلب جديد. هل تريد المتابعة؟",
      "Yes, Edit": "نعم، تعديل",
